// =============================================================================
// PCBTest_05_TriggerGated
//
// Minimal bring-up test - NOT part of the main Sentinel Beam firmware.
// Identical to PCBTest_04, except playback + motor spin-up now wait for a
// trigger press on GPIO4 instead of starting immediately once loaded - so
// this test additionally exercises the trigger switch wiring.
//
...
//   Trigger pressed - playback +
//     motor spin-up start           -> (stays GREEN while both run)
...
// setup(), then behaves exactly like PCBTest_04 from that point on.
// =============================================================================
...
void setup() {
    ...
    Serial.println();
    Serial.println("[PCBTest] SD -> PSRAM -> trigger -> playback + motor bring-up test starting...");
    ...
    Serial.println("[PCBTest] Trigger pressed - starting playback + motor");
